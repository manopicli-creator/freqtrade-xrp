...
class XRPStrategy(IStrategy):
    ...
    stoploss = -0.03  # stoploss dur de sécurité absoluefrom freqtrade.strategy import IStrategy, IntParameter
from pandas import DataFrame
from datetime import datetime
from typing import Optional
import talib.abstract as ta
...
class XRPStrategy(IStrategy):
    ...
    def custom_stake_amount(self, current_time: datetime, current_rate: float,
        ...
        available = max_stake / 0.35  # reconstitue le capital dispo depuis max_stake
